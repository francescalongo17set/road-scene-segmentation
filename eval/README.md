...
* Anomaly Inference Command:```python evalAnomaly.py --input '/path/to/your/dataset/RoadAnomaly21/images/*.png```. Change the dataset path accordingly (see [`data/README.md`](../data/README.md)).
...
**Examples:**
```
python evalAnomaly.py --input '/path/to/your/dataset/RoadAnomaly21/images/*.png'
```
